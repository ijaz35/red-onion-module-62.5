        ...
        <div className=' container order-container mt-5  p-2'>
            <div className="delivery-details p-2">
                ...
                <form>
                    ...
                    <input className='d-block p-3 rounded-3  w-75 ' type="text" name="flat-details" id="flat-details" placeholder='Flat, suite or floor' />
                    <input className='d-block p-3 rounded-3  w-75 my-3 ' type="text" name="business-name" id="business-name" placeholder='Business Name' />
