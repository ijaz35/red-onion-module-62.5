...
const SingleDinner = ({ singleDinner, handlerAddToCart }) => {

    const { name, description, price, img } = singleDinner;
    return (
        <div className='foods-detail col-12 col-md-6 col-lg-4  p-5'>
            <div className="card border-0 mx-auto w-100" style={{ width: '18rem' }}>
                ...
                <div className="card-body">
                    ...
                    <h3> $ {price}</h3>
                    <button onClick={() => handlerAddToCart(singleDinner)} className='btn add-btn px-5 mt-3'>Add To Cart</button>
